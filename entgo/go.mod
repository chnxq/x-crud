...
//replace github.com/chnxq/x-crud/entgo => ./

require (
	entgo.io/ent v0.14.6
	github.com/XSAM/otelsql v0.42.0
	github.com/chnxq/x-crud/api v0.0.0-20260626173211-00e5d4bacd0d
	github.com/chnxq/x-crud/audit v0.0.0-20260626173211-00e5d4bacd0d
	github.com/chnxq/x-crud/pagination v0.0.0-20260626173211-00e5d4bacd0d
	...
	github.com/chnxq/x-utils/id v0.0.0-20260612100514-4160a415201a
	...
	github.com/xiaoqidun/entps v1.53.0
