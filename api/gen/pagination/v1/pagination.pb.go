...
const (
	Sorting_ASC  Sorting_Direction = 0 // 升序
	Sorting_DESC Sorting_Direction = 1 // 降序
)
...
type PagingRequest_Query struct {
	// JSON字符串过滤条件，基础语法：{"field1":"val1", "field2___icontains":"val2"}，具体请参见：https://github.com/chnxq/x-crud/tree/main/pagination/filter/README.md
...
const file_pagination_v1_pagination_proto_rawDesc = "" +
	...
	"\tno_paging\x18\x06 \x01(\bBI\xbaGF\x92\x02C是否不分页，如果为true，则page和pageSize参数无效。H\x06R\bnoPaging\x88\x01\x01\x12\xf5\x01\n" +
	"\x05query\x18\n" +
	" \x01(\tB\xdc\x01\xbaG\xd8\x01:0\x12.{\"field1\":\"val1\", \"field2___icontains\":\"val2\"}\x92\x02\xa2\x01JSON字符串过滤条件，基础语法：{\"key1\":\"val1\",\"key2\":\"val2\"}，具体请参见：https://github.com/chnxq/x-crud/tree/main/pagination/filter/README.mdH\x00R\x05query\x12H\n" +
	...
	"tokenBased\x12D\n" +
	"\tno_paging\x18\x04 \x01(\v2\x14.pagination.NoPagingB\x0f\xbaG\f\x92\x02\t不分页H\x00R\bnoPaging\x12\xf5\x01\n" +
	"\x05query\x18\n" +
	" \x01(\tB\xdc\x01\xbaG\xd8\x01:0\x12.{\"field1\":\"val1\", \"field2___icontains\":\"val2\"}\x92\x02\xa2\x01JSON字符串过滤条件，基础语法：{\"key1\":\"val1\",\"key2\":\"val2\"}，具体请参见：https://github.com/chnxq/x-crud/tree/main/pagination/filter/README.mdH\x01R\x05query\x12H\n" +
	...
	"\x02OR\x10\x02B\x98\x01\n" +
	"\x0ecom.paginationB\x0fPaginationProtoP\x01Z-github.com/chnxq/x-crud/api/gen/pagination/v1\xa2\x02\x03PXX\xaa\x02\n" +
	"Pagination\xca\x02\n" +
